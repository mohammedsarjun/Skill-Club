...
adminRouter.get("/me", authMiddleware, roleGuard("admin"), adminAuthController.me.bind(adminAuthController));
...
adminRouter.patch("/user/updateStatus", adminUserController.updateUserStatus.bind(adminUserController));
