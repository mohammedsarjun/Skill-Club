...
export declare const mapCreateCategoryDtoToCategoryModel: (
  dto: CreateCategoryDTO,
) => Pick<ICategory, 'name' | 'description' | 'status'>;
export declare const mapUpdateCategoryDtoToCategoryModel: (
...
export declare const mapCategoryModelToCategoryDtoMinimal: (
  category: ICategory,
) => CategoryDtoMinimal;
