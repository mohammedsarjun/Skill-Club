...
import { AddressDTO, ClientProfileDetailDTO, ClientProfileUpdateResponseDto, UserDto, UserProfileDto } from '../../dto/userDTO/user.dto.js';
...
export declare class userServices implements IUserServices {
    ...
    constructor(userRepository: IUserRepository, actionVerificationRepository: IActionVerificationRepository);
    ...
    createClientProfile(id: string, clientData: ClientProfileDetailDTO): Promise<ClientProfileUpdateResponseDto>;
