...
import { FreelancerJobDetailResponseDto, FreelancerJobFiltersDto, FreelancerJobResponseDto } from '../../dto/freelancerDTO/freelancer-job.dto';
import AppError from '../../utils/app-error';
import { HttpStatus } from '../../enums/http-status.enum';
...
import { mapFreelancerJobRawFilterToFreelancerJobFiltersDto, mapJobModelToFreelancerJobDetailResponseDTO, mapJobModelToFreelancerJobResponseDTO } from '../../mapper/freelancerMapper/freelancer-job.mapper';

@injectable()
export class FreelancerJobService implements IFreelancerJobService {
  private _jobRepository: IJobRepository;
  private _clientRepository:IClientRepository;
  constructor(@inject('IJobRepository') jobRepository: IJobRepository,@inject('IClientRepository') clientRepository: IClientRepository) {
