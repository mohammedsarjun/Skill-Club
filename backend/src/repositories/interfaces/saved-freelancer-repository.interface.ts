...
export interface ISavedFreelancerRepository extends BaseRepository<ISavedFreelancer> {
  findByClientAndFreelancer(clientId: string, freelancerId: string): Promise<ISavedFreelancer | null>;
  deleteByClientAndFreelancer(clientId: string, freelancerId: string): Promise<ISavedFreelancer | null>;
