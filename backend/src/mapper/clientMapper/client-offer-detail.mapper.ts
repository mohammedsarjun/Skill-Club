...
export const mapOfferModelToClientOfferDetailDTO = (offer: IOffer): ClientOfferDetailDTO => {
  ...
  return {
    ...
    freelancer: typeof offer.freelancerId === 'object' && offer.freelancerId !== null ? {
    ...
    milestones: offer.milestones?.map(m => ({ title: m.title, amount: m.amount, expectedDelivery: m.expectedDelivery })),
